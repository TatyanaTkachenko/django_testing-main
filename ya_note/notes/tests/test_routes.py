...
class TestRoutes(TestCase):
    ...
    def test_pages_availability(self):
        routes = [
            ...
            (reverse('notes:detail'), (self.note.slug,), self.author, HTTPStatus.OK),
            (reverse('notes:edit'), (self.note.slug,), self.author, HTTPStatus.OK),
            (reverse('notes:delete'), (self.note.slug,), self.author, HTTPStatus.OK),
            (reverse('notes:detail'), (self.note.slug,), self.other_user, HTTPStatus.NOT_FOUND),
            (reverse('notes:edit'), (self.note.slug,), self.other_user, HTTPStatus.NOT_FOUND),
            (reverse('notes:delete'), (self.note.slug,), self.other_user, HTTPStatus.NOT_FOUND),
        ]
